            ...
            <div className="flex flex-col gap-8 sm:flex-row sm:items-start">
              ...
              <div className="flex-1">
                ...
                <a
                  ...
                  className="mt-6 inline-flex items-center gap-2 rounded-full bg-foreground px-5 py-2.5 text-sm font-medium text-background transition-opacity hover:opacity-80"
                >
                  <svg
                    width="18"
                    height="18"
